...
p10 + labs(title = "Most Popular Start Stations by Customer Type", y = "", x = "Rides") + theme(legend.title = element_blank(),plot.title = element_text(hjust = 0),axis.ticks.x=element_blank(),axis.text.x=element_blank(), axis.text.y = element_text(hjust = 0))
...
p11 + labs(title = "Most Popular End Stations by Customer Type", x = "Rides", y = "") + theme(legend.title = element_blank(),plot.title = element_text(hjust = 0),axis.ticks.x=element_blank(),axis.text.x=element_blank(), axis.text.y = element_text(hjust = 0)) #+ scale_x_discrete(guide = guide_axis(n.dodge=3))
...
p16 + labs(title = "Most Popular Trips by Customer Type", x = "", y = "", subtitle = "From Start Station to End Station") + theme(legend.title = element_blank(),plot.title = element_text(hjust = 0), plot.subtitle = element_text(hjust = 0), axis.ticks.x=element_blank(), axis.text.x=element_blank(), axis.text.y = element_text(hjust = 0))
